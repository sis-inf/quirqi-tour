...
// node_modules/@strapi/admin/dist/admin/index-QPUYgtlo.mjs
...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-HYXVuTDF-JQITAUJ5.js");
      return {
...
var NotFoundPage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, { labelledBy: "title", children: [
    ...
    (0, import_jsx_runtime.jsx)(Layouts.Content, { children: (0, import_jsx_runtime.jsx)(
      EmptyStateLayout,
      {
        action: (0, import_jsx_runtime.jsx)(LinkButton, { tag: Link2, variant: "secondary", endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4X, {}), to: "/", children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-fE9R8ZE1-FOM2IDYR.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-idMTZOuN-3UDR2CFP.js");
        return {
...
var Login = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Link, { isExternal: false, tag: NavLink, to: "/auth/forgot-password", children: formatMessage({
...
var ForgotPassword = () => {
  ...
  return (0, import_jsx_runtime.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }) }) }) })
  ] }) });
};
var ForgotPasswordSuccess = () => {
  ...
  return (0, import_jsx_runtime.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }) }) }) })
  ] }) });
};
var Oops = () => {
  const { formatMessage } = useIntl();
...
var Register = ({ hasAdmin }) => {
  ...
  return (0, import_jsx_runtime.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime.jsxs)(LayoutContent, { children: [
    ...
    (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-STwy4gIQ-4WN4DO3C.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-T5y8alpG-BYJJEN5M.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CAAa_iYD-DDF5EC7P.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-pPnHpatu-CKHSMTIY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-Fu5aqX9h-WDFO7HZC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-cMqf3hxn-5H3C3HFY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-dZLyVDGx-EPYOPHTA.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-z6N1v5X5-M2EYLQ3I.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-K8aawKOf-32LWPRJC.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4VAaMuov-N4QHJPCU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-JTtPuayE-6WD2HZVJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-8k0KvpoK-HUTUFTVV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-2CHLYZlY-HBZLYLVT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-4UcrE6vq-SCJR4D37.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ziItL2Hn-OL5CZLDF.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-xgk-lEu1-CHWLKXOI.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ngsQKZBi-4QABDVA3.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-K2YmR4Il-O46KTIGI.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-sxd54apY-LYKDBELY.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-QPnZOFrC-6DE65ONH.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-oz8OSt1B-RA5GSJSN.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-EPvpBxko-IDPL6S56.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-s3TgP0pj-Q752L57H.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-dlsF2jYh-YOHAONMO.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-FPcBalFr-H2BSXXBQ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-WfWtk2vt-2UK2KS43.js");
              return {
...
var Links = ({ boundaryCount = 1, siblingCount = 1 }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Pagination, { activePage, pageCount, children: [
    (0, import_jsx_runtime.jsx)(PreviousLink, { tag: Link2, to: { search: (0, import_qs.stringify)({ ...query, page: activePage - 1 }) }, children: formatMessage({
    ...
    (0, import_jsx_runtime.jsx)(NextLink, { tag: Link2, to: { search: (0, import_qs.stringify)({ ...query, page: activePage + 1 }) }, children: formatMessage({
...
//# sourceMappingURL=chunk-MDCROYRT.js.map
