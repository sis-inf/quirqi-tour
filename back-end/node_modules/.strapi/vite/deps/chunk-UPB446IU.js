...
// node_modules/@strapi/content-type-builder/dist/_chunks/index-N6VHEZs0.mjs
...
var Blocker = ({ displayedIcon, description: description2, title, isOpen }) => {
  ...
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime.jsxs)(Overlay, { id: "autoReloadOverlayBlocker", direction: "column", alignItems: "center", gap: 6, children: [
      ...
      displayedIcon === "time" && (0, import_jsx_runtime.jsx)(IconBox, { padding: 6, background: "primary100", borderColor: "primary200", children: (0, import_jsx_runtime.jsx)(ForwardRef$4d, { width: "4rem", height: "4rem" }) }),
...
var index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./index-BgNIUYf6-A3VXSF7N.js").then((n) => n.i),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
//# sourceMappingURL=chunk-UPB446IU.js.map
