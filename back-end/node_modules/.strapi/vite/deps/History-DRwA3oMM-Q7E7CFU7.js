...
// node_modules/@strapi/content-manager/dist/_chunks/History-DRwA3oMM.mjs
...
var PaginationButton = ({ page, children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Link2, { to: { search: (0, import_qs.stringify)({ ...queryRest, page }) }, style: { textDecoration: "none" }, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "omega", textColor: "primary600", children }) });
};
var VersionsList = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=History-DRwA3oMM-Q7E7CFU7.js.map
