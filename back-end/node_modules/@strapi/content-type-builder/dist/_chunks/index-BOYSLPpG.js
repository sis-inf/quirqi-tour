...
const index$1 = require("./index-Bp9_1YUM.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-DNrG3LP8.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-DNrG3LP8.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-BOYSLPpG.js.map
