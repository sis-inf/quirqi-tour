...
import { b as Layouts, v as ContentBox } from './index-QPUYgtlo.mjs';
import { m as useGuidedTour, c as useTracking, e as useAPIErrorHandler, a as useNotification, P as Page, p as useAppInfo } from './Theme-frC82ceE.mjs';
  ...
  return /* @__PURE__ */ jsxs(Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxs(Main, { children: [
      ...
      /* @__PURE__ */ jsxs(Box, { padding: 10, children: [
        /* @__PURE__ */ jsx(Grid.Root, { children: /* @__PURE__ */ jsx(Grid.Item, { col: 8, s: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingBottom: 10, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "flex-start", gap: 5, children: [
        ...
        /* @__PURE__ */ jsxs(Grid.Root, { gap: 6, children: [
          /* @__PURE__ */ jsx(Grid.Item, { col: 8, s: 12, direction: "column", alignItems: "stretch", children: showGuidedTour ? /* @__PURE__ */ jsx(GuidedTourHomepage, {}) : /* @__PURE__ */ jsx(ContentBlocks, {}) }),
          /* @__PURE__ */ jsx(Grid.Item, { col: 4, s: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx(SocialLinks, {}) })
        ] })
      ] })
    ] })
  ] });
    ...
    Flex,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(GridGap, { children: socialLinksExtended.map(({ icon, link, name }) => {
          return /* @__PURE__ */ jsx(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx(LinkCustom, { size: "L", startIcon: icon, variant: "tertiary", href: link, isExternal: true, children: formatMessage(name) }) }, name.id);
        }) })
      ]
    }
  );
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-EDHzBAy8.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-oz8OSt1B.mjs.map
