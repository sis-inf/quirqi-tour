...
import { c as useTracking, r as useConfiguration, p as useAppInfo, k as useRBAC, P as Page } from './Theme-frC82ceE.mjs';
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-qIgh5-QA.mjs')).AdminSeatInfoEE
  );
  const {
...
//# sourceMappingURL=ApplicationInfoPage-FPcBalFr.mjs.map
