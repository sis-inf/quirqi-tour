...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-QPUYgtlo.mjs';
import { u as useAuth, p as useAppInfo, q as useStrapiApp, c as useTracking, P as Page } from './Theme-frC82ceE.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-QPUYgtlo.mjs').then(n => n.J)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-dlsF2jYh.mjs.map
