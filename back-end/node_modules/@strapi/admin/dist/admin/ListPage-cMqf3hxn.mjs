...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-QPUYgtlo.mjs';
import { a as useNotification, e as useAPIErrorHandler, b as useTypedSelector, P as Page, k as useRBAC } from './Theme-frC82ceE.mjs';
import { u as useEnterprise } from './useEnterprise-jpsYZWzn.mjs';
import { g as getDisplayName } from './users-a4KTyEyc.mjs';
import * as yup from 'yup';
import { i as isBaseQueryError } from './admin-GZ-AP2T0.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-esk6LySb.mjs';
...
const ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import('./MagicLinkEE-oXcvyO9m.mjs')).MagicLinkEE
  );
...
const ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(
    CreateActionCE,
    async () => (await import('./CreateActionEE-X2nnG2dm.mjs')).CreateActionEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import('./ListPage-HjeCNXIL.mjs')).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-cMqf3hxn.mjs.map
