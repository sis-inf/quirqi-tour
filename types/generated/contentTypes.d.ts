...
export interface ApiDanzaDanza extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::danza.danza'> &
      Schema.Attribute.Private;
  };
}

export interface ApiFotoFoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    foto: Schema.Attribute.Media<
      ...
      true
    >;
    turismo: Schema.Attribute.Relation<'oneToOne', 'api::turismo.turismo'>;
...
export interface ApiTurismoTurismo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tipo: Schema.Attribute.String;
    descripcion: Schema.Attribute.Text;
    horarioDeApertura: Schema.Attribute.String;
    horarioDeCierre: Schema.Attribute.String;
    ubicacion: Schema.Attribute.String;
    costo: Schema.Attribute.Decimal;
    eventoImportante: Schema.Attribute.String;
    ciudad: Schema.Attribute.Relation<'oneToOne', 'api::ciudad.ciudad'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
